...
{
    public partial class UserStoreWithUserIdTests : IClassFixture<UserFixture<ApplicationUser, IdentityRole, IdentityCloudContext>>
    {
#region Static and Const Members
        ...
        public UserStoreWithUserIdTests(UserFixture<ApplicationUser, IdentityRole, IdentityCloudContext> userFix, ITestOutputHelper output)
        {
            Initialize();
            this.output = output;
            userFixture = userFix;
            userFixture.Init();
            userFixture.UseUserId = true;
            CurrentUser = userFix.CurrentUser;
            CurrentEmailUser = userFix.CurrentEmailUser;

        }

        static UserStoreWithUserIdTests()
        {
            //Look out, hack!
        ...
        private static ApplicationUser GenTestUser()
        {
            ...
            var user = new ApplicationUserWithUserId()
            {
                Email = id.ToString() + "@live.com",
                UserName = id.ToString("N") + ".Name",
                UserId = id.ToString("N"),
